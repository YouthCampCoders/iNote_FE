...
const login: React.FC = (props) => {
  ...
  return <div className="phoneLogin">
    ...
    <div className="bounce">
      ...
      <div className="login">
        <form action="">
          ...
          <div className="verify">
            ...
            <div className="get" onClick={getVerifyCode}>获取验证码</div>
          </div>
        </form>
        <span className="prompt">使用手机号登录时，如未注册则自动注册账号</span>
        <button className="submit">登录</button>
        <span className="other" onClick={()=>choose("other")}>其他方式登陆？</span>
      </div>
      <div className="otherLogin">
        ...
        <div className="choose">
          ...
          <img src={wechat} alt="" onClick={()=>choose("wechat")}/>
        </div>
        <button className="submit">登录</button>
        <span className="other" onClick={()=>choose("phone")}>手机号登录？</span>
      </div>
      <div className="wechatLogin">
        <img src="" alt="" />
        <div className="prompt">打开微信-{'>'}扫一扫</div>
        <span className="other" onClick={()=>choose("wxOther")}>其他方式登陆？</span>
      </div>
    </div>
