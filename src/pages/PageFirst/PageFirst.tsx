  ...
  return <div id="first">
    <div className="first">
      <div className="text">
        ...
        <button className='button' onClick={bounce}>Get Start</button>
      </div>
    ...
    <div className="second">
      <span className="slogan">You Note, We Code!</span>
      <span className="show">You Note, We Code!You Note, We Code!You Note, We Code!You Note, We Code!</span>
      <div className="card">
        <div className="left">
          <img src={icon} alt="" className="icon" />
          <span className="abin">艾宾浩斯遗忘曲线</span>
          <div className="content">配合艾宾浩斯遗忘曲线进行推送配合艾宾浩斯遗忘曲线进行推送配合艾宾浩斯遗忘曲线进行推送配合艾宾浩斯遗忘曲线进行推送配合艾宾浩斯遗忘曲线进行推送配合艾宾浩斯遗忘曲线进行推送配合</div>
        </div>
        <div className="right">
          <img src={icon} alt="" className="icon" />
          <span className="abin">艾宾浩斯遗忘曲线</span>
